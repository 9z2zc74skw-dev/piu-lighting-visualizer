...
export const SKU_TYPES: SkuType[] = [
  // Front / perimeter warning
  {
    ...
    solidBar: true,
    family: "mps63",
    familyName: "MPS63 MicroPulse 6-3 Grille",
  ...
  },
  {
    id: "mps63smk",
    sku: "MPS63-SMK",
    name: "MicroPulse 6-3 Grille (Smoked)",
    group: "front",
    mount: "Grille (pair, L/R of grille)",
    shape: "bar",
    segments: 6,
  ...
  // DynaFlare 2-foot (DR2) — same slim body, ~2x length.
  {
    ...
    group: "front",
    mount: "DynaFlare 2ft perimeter stick — push-bumper channel / rear window",
    shape: "dyna",
    segments: 1,
    spreadDeg: 100,
    lengthPx: 62,
  ...
  },
  {
    ...
    group: "front",
    mount: "DynaFlare 2ft perimeter stick, smoked lens — channel / rear window",
    shape: "dyna",
    segments: 1,
    spreadDeg: 100,
    lengthPx: 62,
  ...
  // DynaFlare 3-foot (DR3).
  {
    ...
    group: "front",
    mount: "DynaFlare 3ft perimeter stick — push-bumper top channel / rear window",
    shape: "dyna",
    segments: 1,
    spreadDeg: 110,
    lengthPx: 62,
    ...
    solidBar: true,
    defaults: {
      front: { x: 50, y: 66, rot: 0 },
      rear: { x: 50, y: 30, rot: 180 },
      hero: { x: 40, y: 62, rot: -6 },
    },
  },
  {
    id: "dr3rbwsmk",
    ...
    group: "front",
    mount: "DynaFlare 3ft perimeter stick, smoked lens — top channel / rear window",
    shape: "dyna",
    segments: 1,
    spreadDeg: 110,
    lengthPx: 62,
  ...
  // DynaFlare 4-foot (DR4) — full-width perimeter stick.
  {
    ...
    group: "front",
    mount: "DynaFlare 4ft perimeter stick — full-width front / rear window",
    shape: "dyna",
    segments: 1,
    spreadDeg: 120,
    lengthPx: 62,
  ...
  },
  {
    ...
    group: "front",
    mount: "DynaFlare 4ft perimeter stick, smoked lens — full-width / rear window",
    shape: "dyna",
    segments: 1,
    spreadDeg: 120,
    lengthPx: 62,
  ...
  // DynaFlare 5-foot (DR5) — CUSTOM extended length (not a standard FedSig
  // catalog size; built to order). Same slim body, ~5x DR1.
  {
    ...
    group: "front",
    mount: "DynaFlare 5ft perimeter stick (custom) — full-width / rear window",
    shape: "dyna",
    segments: 1,
    spreadDeg: 120,
    lengthPx: 62,
  ...
  },
  {
    ...
    group: "front",
    mount: "DynaFlare 5ft perimeter stick, smoked lens (custom) — full-width / rear window",
    shape: "dyna",
    segments: 1,
    spreadDeg: 120,
    lengthPx: 62,
  ...
  // DynaFlare 6-foot (DR6) — CUSTOM extended length (built to order).
  {
    ...
    group: "front",
    mount: "DynaFlare 6ft perimeter stick (custom) — full-width / rear window",
    shape: "dyna",
    segments: 1,
    spreadDeg: 120,
    lengthPx: 62,
  ...
  },
  {
    ...
    group: "front",
    mount: "DynaFlare 6ft perimeter stick, smoked lens (custom) — full-width / rear window",
    shape: "dyna",
    segments: 1,
    spreadDeg: 120,
    lengthPx: 62,
  ...
  },
  {
    ...
    family: "mps123",
    familyName: "MPS123 MicroPulse 12-3 (Hatch)",
    variantLabel: "Clear lens",
    familyDefault: true,
    defaults: {
  ...
  },
  {
    id: "mps123smk",
    sku: "MPS123-SMK",
    name: "MicroPulse 12-3 Hatch (Smoked)",
    group: "hatch",
    mount: "Rear hatch pillars (vertical, plate sides)",
    shape: "bar",
    segments: 6,
